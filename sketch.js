...
var tree, treeImg, stone, stoneImg, ground, boy, boyImg, back;
...
function setup() {
	...
	mango8 = new Mango(1500,350,30);
	mango9 = new Mango(1350,150,30);
	mango10 = new Mango(1250,200,30);
	mango11 = new Mango(1250,350,30);
